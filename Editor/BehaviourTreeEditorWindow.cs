...
namespace TheKiwiCoder
{
    public class BehaviourTreeEditorWindow : EditorWindow
    {
        ...
        {
            if (Application.isPlaying) treeView?.UpdateNodeStates();
        }
        ...
        private void ClearIfSelected(string path)
        {
            ...
            if (AssetDatabase.GetAssetPath(serializer.tree) ==
                path) // Need to delay because this is called from a will delete asset callback
