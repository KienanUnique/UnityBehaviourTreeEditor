...
namespace TheKiwiCoder
{
    ...
    //
    //     [Tooltip("Target Position")] public NodeProperty<Vector3> targetPosition = new() {defaultValue = Vector3.zero};
    //
    ...
    //
    //         if (context.agent.remainingDistance < tolerance.Value) return State.Success;
    //
    //         if (context.agent.pathStatus == NavMeshPathStatus.PathInvalid) return State.Failure;
